...
#
# PyTorch 2.6 + H100: mode="default" causes NoValidChoicesError in flex_attention backward.
# mode="max-autotune-no-cudagraphs" works for both forward and backward.
